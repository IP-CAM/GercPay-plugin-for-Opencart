      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-gercpay"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <select name="gercpay_status" id="gercpay_status" class="form-control">
              ...
              ?>
              <option value="1"
              <?php echo $st1 ?> ><?php echo $text_enabled; ?></option>
              <option value="0"
              <?php echo $st0 ?> ><?php echo $text_disabled; ?></option>
            </select>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <select name="gercpay_currency" id="gercpay_currency" class="form-control">
              ...
              <?= $st ?> ><?php echo $currency['title']; ?></option>
              <?php } ?>
            </select>
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-sm-4 control-label" for="gercpay_order_status_id">
            <span data-toggle="tooltip"
                  title="<?php echo $help_order_status; ?>"><?php echo $entry_order_status; ?></span>
          </label>
          <div class="col-sm-8">
        ...
        <div class="form-group">
          <label class="col-sm-4 control-label" for="gercpay_order_reverse_status_id">
            <span data-toggle="tooltip"
                  title="<?php echo $help_order_reverse_status; ?>"><?php echo $entry_order_reverse_status; ?></span>
          </label>
          <div class="col-sm-8">
            <select name="gercpay_order_reverse_status_id" id="gercpay_order_reverse_status_id"
                    class="form-control">
              <?php foreach ($order_statuses as $order_status) {
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <select name="gercpay_language" id="gercpay_language" class="form-control">
              ...
              ?>
              <option value="<?php echo $payment_page_locale; ?>"
              <?= $st ?> ><?php echo mb_strtoupper($payment_page_locale); ?></option>
              <?php } ?>
            </select>
          </div>
        </div>
