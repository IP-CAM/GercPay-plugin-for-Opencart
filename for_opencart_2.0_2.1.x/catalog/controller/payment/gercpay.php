...
class ControllerPaymentGercpay extends Controller
{
    ...
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/gercpay.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/payment/gercpay.tpl', $data);
        }

        return $this->load->view('default/template/payment/gercpay.tpl', $data);
    }
