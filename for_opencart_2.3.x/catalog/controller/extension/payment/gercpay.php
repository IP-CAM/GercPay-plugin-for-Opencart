...
class ControllerExtensionPaymentGercpay extends Controller
{
    ...
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/extension/payment/gercpay.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/extension/payment/gercpay.tpl', $data);
        }

        return $this->load->view('extension/payment/gercpay.tpl', $data);
    }
